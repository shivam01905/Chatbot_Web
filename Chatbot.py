...
def home():
    if request.method == 'POST':
        ...
        # Process the user command using the Crawler
...
def process_command(user_command):
    # Add logic to process the user command using the Crawler
    # Example:
    if user_command == 'scroll up':
        crawler.scroll('up')
        return 'Scrolled up!'
    elif user_command == 'scroll down':
        crawler.scroll('down')
